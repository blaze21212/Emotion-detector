"""Emotion detection helpers for Watson NLP and Flask output formatting."""
...
def fallback_emotion_detector(text_to_analyze):
    ...
    emotion_keywords = {
        'anger': [
            'angry', 'mad', 'furious', 'hate', 'upset', 'angry',
            'aggravate', 'irritate', 'rage'
        ],
        'disgust': [
            'disgust', 'gross', 'yuck', 'ew', 'gross', 'vomit',
            'sick', 'repugnant'
        ],
        'fear': [
            'afraid', 'scared', 'fear', 'terrified', 'horror',
            'panic', 'anxious', 'nervous'
        ],
        'joy': [
            'happy', 'glad', 'joy', 'cheerful', 'delight', 'love',
            'wonderful', 'amazing', 'great', 'awesome', 'excellent',
            'excited'
        ],
        'sadness': [
            'sad', 'unhappy', 'depressed', 'grief', 'sorrow',
            'miserable', 'upset', 'lonely'
        ]
    }
...
def emotion_detector(text_to_analyse):
    """
    Sends text to the IBM Watson NLP Emotion Predict API and returns the
    raw response text.
    """
