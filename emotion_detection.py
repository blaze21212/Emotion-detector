...
def emotion_detector(text_to_analyze):
    """
    Sends text to the IBM Watson NLP Emotion Predict API and returns
    individual emotion scores alongside the dominant emotion.
    Falls back to local detection if API is unavailable or not configured.
    """
    ...
    try:
        ...
        print("Watson API unavailable, using fallback emotion detector")
        return fallback_emotion_detector(text_to_analyze)